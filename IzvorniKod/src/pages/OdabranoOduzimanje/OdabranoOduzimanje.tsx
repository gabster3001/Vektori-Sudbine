...
const OdabranoOduzimanje: React.FC = () => {
    ...
    return (
        ...
        <Header username="username" level={1} /> {/* Replace with actual values */}
            ...
            <div className="odabrano-oduzimanje-middle">
                <div className="oduzimanje-buttons">
                    <div className="dropdown">
                        ...
                        >
                        sadržaj
                        <ChevronDown className={`dropdown-icon ${isMenuOpen ? 'open' : ''}`} />
                        </button>
                        {isMenuOpen && (
                    ...
                    <button id='one-d' onClick={() => handleScrollToSection("jedna-dimenzija")}>
                        JEDNA DIMENZIJA
                    </button>
                    <button id='two-d' onClick={() => handleScrollToSection("dvije-dimenzije")}>
                        DVIJE DIMENZIJE
                    </button>
                </div>
