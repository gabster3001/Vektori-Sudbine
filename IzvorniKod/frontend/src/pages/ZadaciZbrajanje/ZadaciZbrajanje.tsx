...
export default function ZadaciZbrajanje() {
  return (
    <div className="zadaci-zbrajanje">
      ...
      <main className="main">
        <div className="content-box">
          ...
          <div className="progress-section">
            <div className="progress-title">zadatci iz zbrajanja</div>
            <div className="progress-status">0/10 riješeno</div>
            <div className="progress-buttons">
              <button className="action-button">oduzimanje</button>
